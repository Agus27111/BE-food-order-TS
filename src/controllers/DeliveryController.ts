...
export const DeliverySignUp = async (req: Request, res: Response, next: NextFunction):Promise<any> => {
...
export const DeliveryLogin = async (req: Request, res: Response, next: NextFunction):Promise<any>  => {
...
export const GetDeliveryProfile = async (req: Request, res: Response, next: NextFunction):Promise<any>  => {
...
export const EditDeliveryProfile = async (req: Request, res: Response, next: NextFunction):Promise<any>  => {
